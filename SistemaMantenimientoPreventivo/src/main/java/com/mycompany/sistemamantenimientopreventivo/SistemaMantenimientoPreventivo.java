...
public static void main(String[] args) {
       ...
       */
        ...
        depto.registrarMantenimiento("10/11/2025", torno, tecnico1, cliente1, "Mantenimiento preventivo programado");
        
        tecnico2.realizarMantenimiento(prensa);
        depto.registrarMantenimiento("10/11/2025", prensa, tecnico2, cliente1, "Inspección y ajuste");
        
        tecnico3.realizarMantenimiento(montacarga1);
        depto.registrarMantenimiento("10/11/2025", montacarga1, tecnico3, cliente2, "Mantenimiento vehicular");
        
        tecnico1.realizarMantenimiento(prensa);
        depto.registrarMantenimiento("11/11/2025", prensa, tecnico1, cliente1, "Mantenimiento correctivo");
        
        tecnico3.realizarMantenimiento(montacarga2);
        depto.registrarMantenimiento("11/11/2025", montacarga2, tecnico3, cliente2, "Revision general");
        ...
        // Reporte por cliente
        depto.generarReporteCliente("C001");
        depto.generarReporteCliente("C002");
        
        // Reporte de técnicos
        depto.generarReporteTecnicos();
        
        // Reporte de servicios más utilizados
        depto.generarReporteServiciosMasUtilizados();
